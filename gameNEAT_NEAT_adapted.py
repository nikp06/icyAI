...
class IcyTowerGameAI:
    ...
    def draw_window(self):
        ...
        msg_fitness = 'Highest Fitness: ' + str(self.highest_fitness)
        msg_floors = 'Floors climbed: ' + str(self.highest_floor)
        msg_alive = 'Alive: ' + str(len(self.players))

        SCREEN.blit(FONT.render(msg_time, True, GREEN), (60, 20))
        SCREEN.blit(FONT.render(msg_fitness, True, GREEN), (60, 50))
        SCREEN.blit(FONT.render(msg_floors, True, GREEN), (60, 80))
        SCREEN.blit(FONT.render(msg_alive, True, GREEN), (60, 110))
        # if self.player.combo:
